# 💫 About Me:
- I am a AI Engineer, with working experience in AI/ML, including NLP (RAG, Agentic,...), Computer Vision (Facial Identification,..), Anomaly Detection (Fraud Detction)<br>
- I also have working experience with Full Stack Development (next.js, Javascript, MERN stacks..)<br>
- Passionate in delivering real values and impacts through codes and algorithms<br>
